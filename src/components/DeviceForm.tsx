...
import { api } from '../api'
import type { Device, Protocol } from '../types'
...
export function DeviceForm({ initial, onSubmit, onCancel }: DeviceFormProps) {
  ...
  useEffect(() => {
    ...
    api
      ...
      .then((res) => {
        ...
        // or the existing device's interface isn't one of them: fall back to
        // manual entry so the field is never stuck unusable.
